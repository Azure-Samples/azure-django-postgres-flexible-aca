...
name: Deploy Django Application with PostgreSQL via Azure Container Apps (Python)
description: This project deploys a web application for a space travel agency using Django with Python. 
---
